...
import { EdgeFormattingEditProvider } from './providers/EdgeFormattingEditProvider';
...
export function activate(context: vscode.ExtensionContext) {
    ...
    if (edgeFormatCfg.get<boolean>('enable')) {
        context.subscriptions.push(vscode.languages.registerDocumentFormattingEditProvider(documentSelector, new EdgeFormattingEditProvider));
        context.subscriptions.push(vscode.languages.registerDocumentRangeFormattingEditProvider(documentSelector, new EdgeFormattingEditProvider));
    }
    ...
    let clientOptions: LanguageClientOptions = {
        ...
        synchronize: {
            configurationSection: ['edge', 'css', 'javascript', 'emmet'], // the settings to synchronize
        },
    ...
    let client = new LanguageClient('edge', localize('edgeserver.name', 'EDGE Language Server'), serverOptions, clientOptions);
